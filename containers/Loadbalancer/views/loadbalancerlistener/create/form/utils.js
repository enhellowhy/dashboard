import { schedulerProviderMaps } from '@Loadbalancer/views/loadbalancerlistener/constants'
  ...
  return {
    ...
    backend_server_port: [
      'backend_server_port',
      {
        ...
        normalize: v => Number(v),
        rules: [
          { type: 'integer', required: true, message: i18n.t('loadbalancer.text_7'), trigger: 'blur' },
