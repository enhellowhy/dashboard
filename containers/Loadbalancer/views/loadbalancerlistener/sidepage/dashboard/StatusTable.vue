  ...
  data () {
    return {
      ...
      columns: [
        {
          field: 'svname',
          title: this.$t('loadbalancer.text_16'),
          formatter: ({ row }) => {
        ...
        },
        {
          ...
          slots: {
            default: ({ row }, h) => {
              ...
              return [
                <div class="d-flex">
                  <status status={row.check_status} statusModule={'backendsState'}/>
                </div>,
              ]
            },
          },
        ...
        {
          field: 'time',
          title: this.$t('loadbalancer.text_17'),
          formatter: ({ row }) => this.$moment(row.check_time).format(),
