...
export const DIC = {
  ...
  standard: i18n.t('storage.filesystem.storage.type.standard'),
  performance: i18n.t('storage.filesystem.storage.type.performance'),
  capacity: i18n.t('storage.filesystem.storage.type.capacity'),
  data: i18n.t('storage.bucket.storage.type.standard'),
  cold: i18n.t('storage.bucket.storage.type.cold'),
  archived: i18n.t('storage.bucket.storage.type.archived'),
